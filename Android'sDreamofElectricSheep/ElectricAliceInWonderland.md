...
| **Hierarchical structures** | Medium | <span style="background:#f7e9a0;padding:4px;">Yellow</span> | Good for organizations; tree‑like. |
...
| **Dream‑like topologies** | Very High | <span style="background:#ffb3b3;padding:4px;">Red</span> | Nonlinear, emotionally weighted. |
